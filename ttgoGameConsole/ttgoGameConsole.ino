...
void setup(void) {
 ...
 ledcSetup(pwmLedChannelTFT, pwmFreq, pwmResolution);
  ...
  while(digitalRead(12)==1)// wait until button a is pressed.............
  int nezz=0;
...
if(digitalRead(39)==0 and y<94) //Move down
y=y+sped;

if(digitalRead(38)==0 and y>18) //Move up
y=y-sped;

if(digitalRead(26)==0 and x<125) //Move right
  x=x+sped;

if(digitalRead(33)==0 and  x>0) //Move right
     x=x-sped;
